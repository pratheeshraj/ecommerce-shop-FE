...
export const getAllProducts = () => (dispatch) => {
  ...
  axios
    .get(`${config.api}/api/products/getallproducts`)
    .then((res) => {
      console.log(res);
...
export const getProductById = (productid) => (dispatch) => {
  ...
  axios
    .post(`${config.api}/api/products/getproductbyid`, { productid })
    .then((res) => {
      console.log(res);
...
export const filterProducts=(searchKey , sortKey , category)=>dispatch=>{
    ...
    axios.get(`${config.api}/api/products/getallproducts`).then(res=>{
        ...
        if(category!=='all')
        {
            filteredproducts = res.data.filter(product =>{return product.category.includes(category)})
        }
...
export const addProductReview = (review , productid)=>(dispatch , getState)=>{
  ...
  axios.post(`${config.api}/api/products/addreview` , {review , productid , currentUser}).then(res=>{
    console.log(res);
...
export const deleteProduct=(productid)=>dispatch=>{
  ...
  axios.post(`${config.api}/api/products/deleteproduct` , {productid}).then(res=>{
...
export const addProduct =(product)=> dispatch=>{
      ...
      axios.post(`${config.api}/api/products/addproduct` , {product}).then(res=>{
        console.log(res);
...
export const updateProduct =(productid , updatedproduct)=> dispatch=>{
  ...
  axios.post(`${config.api}/api/products/updateproduct` , {productid , updatedproduct}).then(res=>{
    console.log(res);
